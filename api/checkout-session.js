...
export default async function handler(req, res) {
  ...
  if (!amount || !method || !customer || !customer.name || !customer.address) {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `https://www.lyanadyana.com/success?name=${customer.name}&address=${customer.address}`, // URL kejayaan dengan parameter
